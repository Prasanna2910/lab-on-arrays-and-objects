...
const first= strings.filter(strings=>strings.length>=5)
console.log(first);
...
const squares = numbers.map(function(square){
  return square**2;
})
console.log(squares);
...
const con = alphabets.reduce(function(x,y){
  return x+y;
})
console.log(con);
...
const second = number.find(function(num){
  return num%2==0;
})
console.log(second)
...
const ret = ranks.findIndex(function(rank){
  return rank==7
})
console.log(ret)
...
//3:8
const num = [2, 4, 6, 8];
const third = num.forEach(function(nu, index){
  console.log(index,":",nu)
})
...
const contain = marks.some(function(marks){
  return marks<45;
})
console.log(contain)
...
const element = marks.every(function(positive){
  return marks>0;
})
console.log(element)
...
console.log(1,".","Audi");
console.log(2,".","Toyota red");
console.log(3,".","Hyundai black 5");
console.log(4,".","Renault silver 6");
...
// this is for the deletion of the phone number
delete person.phoneno;
console.log(person);
// this is to check whether the person(object) has bike and house (properties) using hasOwnPreperty
console.log(person.hasOwnProperty("bike","house"));
// to join and print the name
console.log("Mr.", person.name,"travels by the plane called Air123")
